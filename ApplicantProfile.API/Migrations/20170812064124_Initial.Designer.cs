...
namespace ApplicantProfile.API.Migrations
{
    ...
    [Migration("20170812064124_Initial")]
        ...
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ApplicantProfile.Model.Applicant", b =>
            {
                ...
                b.Property<DateTime>("AddedDate")
                    .ValueGeneratedOnAdd()
                    .HasDefaultValue(new DateTime(2017, 7, 29, 5, 30, 13, 368, DateTimeKind.Local));
                ...
                b.Property<DateTime>("ModifiedDate")
                    .ValueGeneratedOnAdd()
                    .HasDefaultValue(new DateTime(2017, 7, 29, 5, 30, 13, 382, DateTimeKind.Local));
            ...
            modelBuilder.Entity("ApplicantProfile.Model.Education", b =>
            {
                ...
                b.Property<DateTime>("AddedDate")
                    .ValueGeneratedOnAdd()
                    .HasDefaultValue(new DateTime(2017, 7, 29, 5, 30, 13, 383, DateTimeKind.Local));
            ...
            modelBuilder.Entity("ApplicantProfile.Model.Experience", b =>
            {
                ...
                b.Property<DateTime>("AddedDate")
                    .ValueGeneratedOnAdd()
                    .HasDefaultValue(new DateTime(2017, 7, 29, 5, 30, 13, 385, DateTimeKind.Local));
            ...
            modelBuilder.Entity("ApplicantProfile.Model.JobTitle", b =>
            {
                ...
                b.Property<DateTime>("AddedDate")
                    .ValueGeneratedOnAdd()
                    .HasDefaultValue(new DateTime(2017, 7, 29, 5, 30, 13, 387, DateTimeKind.Local));
            ...
            modelBuilder.Entity("ApplicantProfile.Model.Qualification", b =>
            {
                ...
                b.Property<DateTime>("AddedDate")
                    .ValueGeneratedOnAdd()
                    .HasDefaultValue(new DateTime(2017, 7, 29, 5, 30, 13, 388, DateTimeKind.Local));
